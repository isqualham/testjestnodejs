...
describe("Get Statement Operation", function () {
    beforeEach(function () {
        ...
        getStatementOperationUseCase = new GetStatementOperationUseCase_1.GetStatementOperationUseCase(userInMemory, statementInMemory);
    });
    it("deve retornar uma operação do statement", function () { return __awaiter(void 0, void 0, void 0, function () {
        var user, statement, operation;
    ...
    it("não deve retornar uma operação do statement quando o usuário não existe", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            //cenário
            //ação
            //validação
            ...
            }); }).rejects.toBeInstanceOf(GetStatementOperationError_1.GetStatementOperationError);
            return [2 /*return*/];
        });
    }); });
    it("não deve retornar uma operação do statement quando o statement não existe", function () { return __awaiter(void 0, void 0, void 0, function () {
        var user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, userInMemory.create({
