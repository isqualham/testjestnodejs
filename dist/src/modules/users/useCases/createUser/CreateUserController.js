...
var CreateUserController = /** @class */ (function () {
    ...
    CreateUserController.prototype.execute = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, email, password, createUser;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = request.body, name = _a.name, email = _a.email, password = _a.password;
                        createUser = tsyringe_1.container.resolve(CreateUserUseCase_1.CreateUserUseCase);
